...
# ============================================================================
# Tutor AI Chat (Automatic Conversation)
# ============================================================================
...
def generate_tutor_greeting(req: https_fn.Request) -> https_fn.Response:
    ...
    try:
        ...
        system_prompt = f"""You are {tutor_name}, an AI language tutor with the following personality:

{tutor_personality}

Your task is to generate a warm, engaging welcome message for a new student named {user_name} who has just started a chat with you.

Your greeting should:
1. Be warm, friendly, and match your personality
2. Introduce yourself briefly (1-2 sentences)
3. Express enthusiasm about helping them learn
4. End with an engaging question to get them talking (ask about their goals, interests, or current level)
...
Remember: This is the first message the student will see from you, so make it count! Be encouraging and make them excited to learn."""
        ...
        user_prompt = f"Generate a welcoming first message for {user_name}."
...
Generate your next response. Remember to stay in character, be helpful and engaging, and guide the conversation forward with a question or prompt."""
        ...
        llm = ChatOpenAI(
            model="gpt-4o-mini",
            temperature=0.85,  # High temperature for personality but not too random
            openai_api_key=openai_api_key
        )
